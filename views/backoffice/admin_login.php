...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* ── Login wrapper ── */
        .login-wrapper { width:100%; max-width:450px; padding:2rem; margin-top:3rem; }
...
<nav class="navbar">
    <a href="<?= BASE_URL ?>controllers/UserController.php?action=index" class="nav-logo">
        <img src="<?= BASE_URL ?>uploads/photos/photo.png" alt="EcoRide" style="width:60px;height:60px;object-fit:contain;background:transparent;vertical-align:middle;">
        <span style="font-family:'Poppins',sans-serif;font-size:1.3rem;font-weight:400;color:#fff;letter-spacing:0.01em;">Eco<strong>Ride</strong></span>
    </a>
    <ul class="nav-links">
        ...
        <li><a href="<?= BASE_URL ?>controllers/UserController.php?action=index#covoiturage">Covoiturage</a></li>
        <li><a href="<?= BASE_URL ?>controllers/UserController.php?action=index#lostfound">Lost&amp;Found</a></li>
        ...
        <li><a href="<?= BASE_URL ?>controllers/UserController.php?action=index#features">Fonctionnalités</a></li>
    </ul>
</nav>
<?php
...
<div class="login-wrapper">
    <div class="logo">
        <img src="<?= BASE_URL ?>uploads/photos/photo.png" alt="EcoRide Logo" style="width:60px;height:60px;object-fit:contain;background:transparent;display:block;margin:0 auto 0.5rem;">
