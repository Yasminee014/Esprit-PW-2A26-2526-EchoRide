<?php
/* ──────────────────────────────────────────────────────────────
 *  SIDEBAR SPA  (admin_dashboard, événements, sponsors…)
 *  Liens réels vers le dashboard (?tab=…) pour navigation hors page SPA.
 * ────────────────────────────────────────────────────────────── */
function sidebar_spa(string $activePage = 'dashboard'): void
{
    $dash      = BASE_URL . 'controllers/AdminController.php?action=dashboard';
    $eventsHub = BASE_URL . 'views/backoffice/dashboard_event.php';
    $is        = fn(string $page) => $activePage === $page ? ' class="active"' : '';
    ?>
    ...
    <div class="sidebar">
        <div>
            ...
            <nav>
                <ul>
                    <li><a href="<?= htmlspecialchars($dash) ?>"<?= $is('dashboard') ?>><i class="fas fa-gauge-high"></i> Dashboard</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=passagers"<?= $is('passagers') ?>><i class="fas fa-users"></i> Passagers</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=trajets"<?= $is('trajets') ?>><i class="fas fa-route"></i> Trajets</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=destinations"<?= $is('destinations') ?>><i class="fas fa-map-pin"></i> Destinations</a></li>
                    <li><a href="<?= htmlspecialchars($eventsHub) ?>"<?= $is('evenements') ?>><i class="fas fa-calendar-alt"></i> Événements</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=reclamations"<?= $is('reclamations') ?>><i class="fas fa-triangle-exclamation"></i> Réclamations</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=vehicules"<?= $is('vehicules') ?>><i class="fas fa-car"></i> Véhicules</a></li>
                    <li><a href="<?= htmlspecialchars($dash) ?>&amp;tab=lost_found"<?= $is('lost_found') ?>><i class="fas fa-magnifying-glass"></i> Objets perdus</a></li>
                </ul>
            </nav>
        </div>
...
function sidebar_dashboard(string $activePage = ''): void
{
    ...
    <div class="sidebar" id="sidebar">
        <div>
            ...
            <nav>
                <ul>
                    <li><a href="<?= htmlspecialchars($url) ?>"               <?= $a('dashboard') ?>><i class="fas fa-gauge-high"></i> Dashboard</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=passagers" <?= $a('passagers') ?>><i class="fas fa-users"></i> Passagers</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=trajets" <?= $a('trajets') ?>><i class="fas fa-route"></i> Trajets</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=destinations" <?= $a('destinations') ?>><i class="fas fa-map-pin"></i> Destinations</a></li>
                    <li><a href="<?= htmlspecialchars($eventsHub) ?>" <?= $activePage === 'evenements' ? 'class="active"' : '' ?>><i class="fas fa-calendar-alt"></i> Événements</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=reclamations" <?= $a('reclamations') ?>><i class="fas fa-triangle-exclamation"></i> Réclamations</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=vehicules" <?= $a('vehicules') ?>><i class="fas fa-car"></i> Véhicules</a></li>
                    <li><a href="<?= htmlspecialchars($url) ?>&amp;tab=lost_found" <?= $a('lost_found') ?>><i class="fas fa-magnifying-glass"></i> Objets perdus</a></li>
                </ul>
            </nav>
        </div>
        <div class="sidebar-footer">
