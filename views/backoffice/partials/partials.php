...
function render_nav_css(): void
{
    ...
    <style>
         ...
         *  RESPONSIVE — commun
         * ════════════════════════════════════════════════════ */
        /* Layout pages avec sidebar SPA (dashboard admin, événements…) — même grille que admin_dashboard (.page-content) */
        .app-wrapper {
            display: flex;
            width: 100%;
            min-height: 100vh;
        ...
        @media (max-width: 768px) {
            ...
            .app-wrapper > .main-content { margin-left: 0 !important; width: 100% !important; padding: 0 !important; }
            .app-wrapper > .main-content > .page-content { padding: 1rem; }
