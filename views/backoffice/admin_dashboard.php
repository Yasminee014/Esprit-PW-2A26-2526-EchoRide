...
<body>
    <div style="display: flex; width:100%; overflow-x:hidden;">
        ...
        <div class="sidebar">
            <div>
                ...
                <nav>
                    <ul>
                        <li><a href="#" class="active" data-page="dashboard"><i class="fas fa-gauge-high"></i> Dashboard</a></li>
                        <li><a href="#" data-page="passagers"><i class="fas fa-users"></i> Passagers</a></li>
                        <li><a href="#" data-page="trajets"><i class="fas fa-route"></i> Trajets</a></li>
                        <li><a href="#" data-page="destinations"><i class="fas fa-map-pin"></i> Destinations</a></li>
                        <li><a href="#" data-page="evenements"><i class="fas fa-calendar-alt"></i> Événements</a></li>
                        <li><a href="#" data-page="reclamations"><i class="fas fa-triangle-exclamation"></i> Réclamations</a></li>
                        <li><a href="#" data-page="vehicules"><i class="fas fa-car"></i> Véhicules</a></li>
                        <li><a href="#" data-page="lost_found"><i class="fas fa-magnifying-glass"></i> Lost &amp; Found</a></li>
                    </ul>
                </nav>
            </div>
            <div class="sidebar-footer">
                <a href="<?= BASE_URL ?>controllers/AdminController.php?action=logout" class="logout-btn"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="top-bar">
                    <div class="navbar-logo"><strong>ECO RIDE</strong><span>Covoiturage Intelligent</span></div>
                    <div class="top-bar-right">
                        ...
                        <button class="btn-theme-toggle" onclick="toggleTheme()" title="Mode sombre / clair"><i class="fas fa-moon themeIcon"></i></button>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('.sidebar nav ul li a').forEach(item => { item.addEventListener('click', function(e) { e.preventDefault(); showPage(this.dataset.page); }); });
