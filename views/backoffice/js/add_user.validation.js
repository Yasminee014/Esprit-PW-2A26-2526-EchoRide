/**
 * Validation JS - Backoffice : Ajouter un utilisateur
 * Fichier : views/backoffice/js/add_user.validation.js
 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.querySelector('form[action*="action=addUser"]');
    if (!form) return;
    ...
    form.addEventListener('submit', function (e) {
        ...
        // Mot de passe
        const pwdResult = validatePassword(pwdInput ? pwdInput.value : '');
        if (!pwdResult.valid) {
