...
<nav class="navbar-modern">
    ...
    <ul class="nav-links" id="navLinks">
        ...
        <li><a href="/ecoride/index.php">Événements</a></li>
        <li><a href="/ecoride/index.php">Sponsors</a></li>
        <li><a href="/ecoride/View/frontoffice/tous_les_trajets.php">Covoiturage</a></li>
        <li><a href="/ecoride/View/frontoffice/lostfound_front.php">Lost &amp; Found</a></li>
        ...
        <li class="profile-dropdown">
            ...
            <div class="dropdown-menu" id="profileDropdown">
                ...
                <div class="dropdown-links">
                    ...
                    <a href="/ecoride/View/frontoffice/tous_les_trajets.php"><i class="fas fa-route"></i> Tous les trajets</a>
        ...
        <li><a href="admin_reclamations.php" class="admin-btn">Admin</a></li>
