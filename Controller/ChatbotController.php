...
class ChatbotController {
    ...
    private function callGroq(string $message, array $history): ?string {
        $system = <<<SYS
Tu es EcoBot, un assistant virtuel intelligent et sympathique de la plateforme de covoiturage "Eco Ride".
...
- Covoiturage, transport, trajets, réservations, conseils voyage 🚗
...
- Mets en valeur les services de covoiturage Eco Ride quand c'est pertinent
SYS;
