...
require_once __DIR__ . '/../Model/LostFoundPredictionService.php';
...
final class LostFoundAdminController
{
    ...
    public function listWithPrediction(): array
    {
        try {
            ...
            // Log l'erreur sans casser la page
            error_log('[LostFoundAdminController] listWithPrediction error: ' . $e->getMessage());
            return [];
        }
    }
