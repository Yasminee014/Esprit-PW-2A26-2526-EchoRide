...
<nav class="navbar-modern">
  ...
  <ul class="nav-links" id="navLinks">
    <!-- Bouton Accueil -->
    <li><a href="http://localhost/ecoride/View/frontoffice/vehicules_disponibles.php" >Accueil</a></li>
        
    <li><a href="http://localhost/ecoride/View/frontoffice/evenements.php">Événements</a></li>
    <li><a href="http://localhost/ecoride/View/frontoffice/sponsors.php">Sponsors</a></li>
    <li><a href="http://localhost/ecoride/View/frontoffice/vehicules_disponibles.php" >Covoiturage</a></li>
    <li><a href="http://localhost/objet_perdu1/objet_perdu/view/Front%20office/lostfound_front.php" class="active"><i class="fas fa-search"></i> Lost &amp; Found</a></li>
    ...
    <li class="profile-dropdown">
      ...
      <div class="dropdown-menu" id="profileDropdown">
        ...
        <div class="dropdown-links">
          ...
          <a href="http://localhost/ecoride/View/frontoffice/tous_les_trajets.php"><i class="fas fa-route"></i> Tous les trajets</a>
          ...
          <a href="http://localhost/ecoride/View/frontoffice/reclamations.php"><i class="fas fa-exclamation-triangle"></i> Réclamations</a>
          <a href="http://localhost/ecoride/View/frontoffice/mes_objets_perdus.php"><i class="fas fa-search"></i> Mes objets perdus</a>
        </div>
    ...
    <!-- Bouton Admin -->
    <li><a href="http://localhost/objet_perdu1/objet_perdu/view/Back%20office/lostfound_admin.php" class="admin-btn">Admin</a></li>
...
<<<<<<< HEAD
  ...
  <script src="../assets/js/lostfound_front_php.js?v=20260429"></script>
</body>
</html>
