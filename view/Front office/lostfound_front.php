...
<nav class="navbar-modern">
  ...
  <ul class="nav-links" id="navLinks">
    ...
    <li><a href="http://localhost/objet_perdu/objet_perdu/view/Front%20office/lostfound_front.php" class="active"><i class="fas fa-search"></i> Lost &amp; Found</a></li>
    ...
    <li class="profile-dropdown">
      ...
      <div class="dropdown-menu" id="profileDropdown">
        ...
        <div class="dropdown-links">
          ...
          <a href="http://localhost/ecoride_reclamations_mvc%20-%20Copie%20(2)/ecoride_reclamations_mvc%20-%20Copie%20(2)/index.php
"><i class="fas fa-exclamation-triangle"></i> Réclamations</a>
    ...
    <!-- Bouton Admin -->
    <li><a href="http://localhost/objet_perdu/objet_perdu/view/Back%20office/lostfound_admin.php" class="admin-btn">Admin</a></li>
