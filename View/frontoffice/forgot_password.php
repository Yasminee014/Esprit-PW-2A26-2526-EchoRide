...
<body>
    <div class="container">
        <div class="card">
            <div class="logo">
                <img src="<?= BASE_URL ?>uploads/photos/photo.png" alt="EcoRide Logo" onerror="this.src='<?= BASE_URL ?>serve_image.php?type=logo'" style="width:60px;height:60px;object-fit:contain;background:transparent;display:block;margin:0 auto 0.5rem;">
            ...
            <div id="step3" class="step hidden">
                <form id="passwordForm" method="POST" action="<?= BASE_URL ?>Controller/UserController.php?action=resetPassword">
    ...
    <script>
    window.FP_CONFIG = {
        sendResetUrl: "<?= BASE_URL ?>Controller/UserController.php?action=sendResetCode",
    ...
    <script src="<?= BASE_URL ?>View/frontoffice/js/forgot_password.validation.js"></script>
</body>
</html>