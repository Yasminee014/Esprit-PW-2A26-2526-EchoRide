<?php
// Header avec fond dégradé bleu, bouton actif bleu foncé
...
/* ── Widget floating en bas à droite ── */
...
/* Cacher le texte "Google Translate" dans le gadget */
...
<nav class="navbar-modern">
    ...
    <ul class="nav-links" id="navLinks">
        <!-- Bouton Accueil -->
        <li><a href="vehicules_disponibles.php" <?= basename($_SERVER['PHP_SELF']) == 'vehicules_disponibles.php' ? 'class="active"' : '' ?>>Accueil</a></li>
        
        <li><a href="evenements.php" <?= basename($_SERVER['PHP_SELF']) == 'evenements.php' ? 'class="active"' : '' ?>>Événements</a></li>
        <li><a href="sponsors.php" <?= basename($_SERVER['PHP_SELF']) == 'sponsors.php' ? 'class="active"' : '' ?>>Sponsors</a></li>
        <li><a href="vehicules_disponibles.php" <?= basename($_SERVER['PHP_SELF']) == 'vehicules_disponibles.php' ? 'class="active"' : '' ?>>Covoiturage</a></li>
        <li><a href="lost_found.php" <?= basename($_SERVER['PHP_SELF']) == 'lost_found.php' ? 'class="active"' : '' ?>><i class="fas fa-search"></i> Lost & Found</a></li>
        ...
        <li class="profile-dropdown">
            ...
            <div class="dropdown-menu" id="profileDropdown">
                ...
                <div class="dropdown-links">
                    ...
                    <a href="tous_les_trajets.php"><i class="fas fa-route"></i> Tous les trajets</a>
                    <a href="mes_trajets.php"><i class="fas fa-map-marker-alt"></i> Mes trajets</a>
                    ...
                    <a href="mes_favoris.php"><i class="fas fa-heart"></i> Mes favoris</a>
...
function changeGoogleLang(langCode) {
