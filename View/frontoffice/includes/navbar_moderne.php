...
<nav class="navbar-modern">
    ...
    <ul class="nav-links" id="navLinks">
        ...
        <li><a href="/ecoride/index.php" <?= basename($_SERVER['PHP_SELF']) == 'evenements.php' ? 'class="active"' : '' ?>>Événements</a></li>
        <li><a href="/ecoride/index.php" <?= basename($_SERVER['PHP_SELF']) == 'sponsors.php' ? 'class="active"' : '' ?>>Sponsors</a></li>
     ...
     <li><a href="/ecoride/View/frontoffice/lostfound_front.php"<?= basename($_SERVER['PHP_SELF']) === 'lostfound_front.php' ? ' class="active"' : '' ?>><i class="fas fa-search"></i> Lost & Found</a></li>
        <li class="profile-dropdown">
            ...
            <div class="dropdown-menu" id="profileDropdown">
                ...
                <div class="dropdown-links">
                    ...
                    <a href="/ecoride/View/frontoffice/lostfound_front.php"><i class="fas fa-search"></i> Mes objets perdus</a>
                </div>
