...
function sidebar_spa(string $activePage = 'dashboard'): void
{
    ...
    <div class="sidebar">
        <div>
            ...
            <nav>
                <ul>
                    <li><a href="<?= BASE_URL ?>View/backoffice/admin_dashboard.php" <?= $activePage === 'dashboard' ? 'class="active"' : '' ?>><i class="fas fa-gauge-high"></i> Dashboard</a></li>
                    <li><a href="<?= BASE_URL ?>View/backoffice/admin_trajet.php?page=passagers" <?= $a('passagers') ?>><i class="fas fa-users"></i> Passagers</a></li>
                    ...
                    <li><a href="<?= BASE_URL ?>View/backoffice/dashboard_event.php" <?= $activePage === 'evenements' ? 'class="active"' : '' ?>><i class="fas fa-calendar-alt"></i> Événements</a></li>
        ...
        <div class="sidebar-footer">
            <a href="<?= BASE_URL ?>Controller/AdminController.php?action=logout" class="logout-btn">
...
{
    $a   = fn(string $page) => $activePage === $page ? 'class="active"' : '';
    $url = BASE_URL . 'View/backoffice/admin_dashboard.php';
    ?>
    <!-- ══ SIDEBAR DASHBOARD ══ -->
...
function sidebar_compact(string $activeItem = ''): void
{
    ...
    <aside class="sidebar" style="width:260px;background:#0D1F3A;border-right:1px solid #1976D2;">
        ...
        <a href="<?= BASE_URL ?>View/backoffice/admin_dashboard.php"
           class="nav-item <?= $a('dashboard') ?>">
            <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        <a href="<?= BASE_URL ?>Controller/AdminController.php?action=listUsers"
           class="nav-item <?= $a('users') ?>">
            <i class="fas fa-users"></i> Utilisateurs
        </a>
        <a href="<?= BASE_URL ?>Controller/AdminController.php?action=showAddUser"
           class="nav-item <?= $a('add_user') ?>">
            <i class="fas fa-user-plus"></i> Ajouter utilisateur
        </a>
        <a href="<?= BASE_URL ?>Controller/AIController.php?action=showAssistant"
