    ...
    <div class="page-content">
        ...
        <div class="details-panel">
            ...
            <div class="panel-header">
                ...
                <a href="<?= BASE_URL ?>View/backoffice/admin_trajet.php?page=passagers" class="btn-back-panel">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="<?= BASE_URL ?>Controller/AdminController.php?action=editPassager" id="editPassagerForm" novalidate>
...
<a href="<?= BASE_URL ?>View/backoffice/admin_trajet.php?page=passagers"
