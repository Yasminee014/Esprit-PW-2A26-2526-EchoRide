                ...
                <tbody>
                    ...
                    <?php else: foreach ($reclamations as $r): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <a href="/ecoride/View/backoffice/admin_historique_reclamation.php?id=<?= intval($r['id']) ?>" class="btn-action history" title="Voir historique" style="text-decoration:none;">
...
function sendMsg() {
    ...
    addMsg(msg, 'user');
    showTyping();
    fetch('/ecoride/Controller/ChatbotController.php', {
        method: 'POST',
