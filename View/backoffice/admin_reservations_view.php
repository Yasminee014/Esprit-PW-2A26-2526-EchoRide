...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar { width:280px; background:linear-gradient(180deg,#2F76BC 0%,#1E5EA5 50%,#174C8A 100%); padding:1.5rem 0; position:fixed; top:0; left:0; height:100vh; overflow-y:auto; box-shadow:4px 0 20px rgba(0,0,0,.2); display:flex; flex-direction:column; }
        .sidebar .logo { margin-bottom:1.5rem; padding:1.5rem; padding-bottom:1.5rem; border-bottom:1px solid rgba(255,255,255,.15); text-align:center; }
        .sidebar .logo i { font-size:48px; color:#A9D6FF; margin-bottom:10px; display:block; }
        .sidebar .logo h2 { color:#A9D6FF; font-size:1.5rem; }
        .sidebar .logo p { color:#BFD8F1; font-size:.75rem; letter-spacing:2px; }
        .sidebar nav ul { list-style:none; }
        .sidebar nav ul li { margin-bottom:.25rem; }
        .sidebar nav ul li a { display:flex; align-items:center; gap:12px; padding:.7rem 1.5rem; color:#EAF4FF; text-decoration:none; border-radius:10px; transition:all .3s; margin:0 .5rem; font-size:.85rem; font-weight:500; }
        .sidebar nav ul li a i { width:22px; color:#EAF4FF; }
        .sidebar nav ul li a:hover { background:rgba(111,168,220,.3); transform:translateX(5px); }
        .sidebar nav ul li a.active { background:linear-gradient(135deg,#6FA8DC,#8FC1F5); color:#fff; box-shadow:0 4px 12px rgba(111,168,220,.3); border-left:none; }
    ...
    <main class="main-content">
        <div class="top-bar">
            ...
            <div class="top-bar-right">
                <a href="/ecoride/View/frontoffice/tous_les_trajets.php" class="nav-btn">Voir site</a>
                <a href="profil.php" class="nav-btn"><i class="fas fa-user"></i> Profil</a>
                <a href="admin.php" class="admin-badge"><i class="fas fa-shield-alt"></i> Admin</a>
            </div>
        </div>
