...
// $passagers injecté par listPassagers()
?>
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .count-badge {
            background:rgba(25,118,210,0.2); color:#61B3FA;
        ...
        .alert {
            ...
            margin-bottom:1.5rem; display:flex; align-items:center; gap:10px; font-size:0.9rem;
        }
        ...
        /* ── Filters bar ── */
        .filters-bar {
            background:rgba(13,31,58,0.9); border-radius:16px; padding:1.2rem 1.5rem;
            border:1px solid rgba(25,118,210,0.2); margin-bottom:1.5rem;
            display:flex; gap:1rem; flex-wrap:wrap; align-items:center;
        }
        .search-input {
            flex:1; min-width:220px; padding:0.6rem 1rem 0.6rem 2.4rem;
            border-radius:25px; border:1px solid rgba(25,118,210,0.3);
            background:rgba(10,22,40,0.8); color:#fff; font-size:0.9rem;
        }
        .search-wrap { position:relative; flex:1; min-width:220px; }
        .search-wrap i { position:absolute; left:0.9rem; top:50%; transform:translateY(-50%); color:#A7A9AC; font-size:0.85rem; }
        .search-input:focus { outline:none; border-color:#1976D2; }
        .filter-select {
            padding:0.6rem 1rem; border-radius:25px;
            border:1px solid rgba(25,118,210,0.3); background:rgba(10,22,40,0.8);
            color:#fff; font-size:0.9rem; cursor:pointer; min-width:160px;
        }
        .filter-select:focus { outline:none; border-color:#1976D2; }
        .btn-pdf {
            display:inline-flex; align-items:center; gap:8px;
            background:#e53e3e; color:#fff; padding:0.6rem 1.2rem;
            border-radius:25px; border:none; font-size:0.9rem; font-weight:600;
        ...
        /* ── Section card ── */
        .section-card {
            background:rgba(13,31,58,0.9); border-radius:20px; padding:1.5rem;
            border:1px solid rgba(25,118,210,0.2);
        }
        .table-wrapper { overflow-x:auto; }
        table { width:100%; border-collapse:collapse; font-size:0.9rem; }
        thead th {
            background:rgba(25,118,210,0.15); color:#1976D2;
        ...
        .page-btn {
            background:rgba(13,31,58,0.9); border:1px solid rgba(25,118,210,0.3);
            color:#A7A9AC; padding:0.4rem 0.8rem; border-radius:8px;
            cursor:pointer; font-size:0.85rem; transition:all 0.2s; min-width:36px; text-align:center;
        }
                ...
                <tbody id="tableBody">
                    ...
                    <?php else: ?>
                        ...
                        <tr data-nom="<?= strtolower(htmlspecialchars($p['prenom'] . ' ' . $p['nom'])) ?>"
                            ...
                            <td><?= htmlspecialchars(!empty($p['created_at']) ? date('d/m/Y', strtotime($p['created_at'])) : '—') ?></td>
                            <td>
