...
if (!$vehicule) {
    $_SESSION['errors'] = ['Véhicule non trouvé.'];
    header('Location: admin.php?tab=vehicules');
    exit;
}
...
<body>
<div class="container">
    <a href="admin.php?tab=vehicules" class="back-link"><i class="fas fa-arrow-left"></i> Retour à la liste</a>

    <h1><i class="fas fa-edit"></i> Modifier le véhicule</h1>
    <div class="subtitle">Modifiez les informations du véhicule</div>
    ...
    <form method="POST" id="vehiculeForm">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="marque" id="marque" value="<?= htmlspecialchars($vehicule['marque']) ?>">
                <span class="field-error" id="marqueError"></span>
            </div>
            <div class="form-group">
                <label>Modèle <span class="required">*</span></label>
                <input type="text" name="modele" id="modele" value="<?= htmlspecialchars($vehicule['modele']) ?>">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="immatriculation" id="immatriculation" placeholder="AB-123-CD" value="<?= htmlspecialchars($vehicule['immatriculation']) ?>">
                <span class="field-error" id="immatriculationError"></span>
            </div>
            <div class="form-group">
                <label>Couleur</label>
                <input type="text" name="couleur" id="couleur" placeholder="Rouge" value="<?= htmlspecialchars($vehicule['couleur'] ?? '') ?>">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="capacite" id="capacite" value="<?= $vehicule['capacite'] ?>">
...
<script>
// ═══════════════════════════════════════════════════════════
//  CONTRÔLE DE SAISIE - Formulaire de modification de véhicule
