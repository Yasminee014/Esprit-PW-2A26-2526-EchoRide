    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a class="nav-btn" href="/ecoride/admin_reclamations.php"><i class="fas fa-exclamation-triangle"></i> Réclamations</a></li>
                <li><a class="nav-btn" href="admin.php"><i class="fas fa-car"></i> Véhicules</a></li>
                <li><a class="nav-btn" href="lostfound_admin.php"><i class="fas fa-search-location"></i> Lost &amp; Found</a></li>
            </ul>
        </nav>
