...
<nav class="navbar">
    <a class="logo" href="<?= BASE_URL ?>Controller/UserController.php?action=index">
    ...
    <ul class="nav-links">
        <li><a href="<?= BASE_URL ?>Controller/UserController.php?action=index#hero">Accueil</a></li>
        <li><a href="<?= BASE_URL ?>Controller/UserController.php?action=index#evenements">Événements</a></li>
        <li><a href="<?= BASE_URL ?>Controller/UserController.php?action=index#sponsors">Sponsors</a></li>
        <li><a href="<?= BASE_URL ?>Controller/UserController.php?action=showRegister">S'inscrire</a></li>
        <li><a href="<?= BASE_URL ?>Controller/UserController.php?action=showLoginForm">Se connecter</a></li>
        <!-- Bouton toggle thème -->
        <li>
...
<div class="login-wrapper">
    ...
    <div class="card">
        ...
        <form id="adminLoginForm" method="POST" action="<?= BASE_URL ?>Controller/AdminController.php?action=login" novalidate>
    ...
    <div class="back-link">
        <a href="<?= BASE_URL ?>Controller/UserController.php?action=index">
            <i class="fas fa-arrow-left"></i> Retour au site
        </a>
    </div>
</div>
<script src="<?= BASE_URL ?>View/backoffice/js/admin_login.validation.js"></script>
...
async function loadProfileDescriptor(email) {
    const res  = await fetch('<?= BASE_URL ?>Controller/AdminController.php?action=getFaceImage', {
        method: 'POST',
...
function submitPendingForm() {
    ...
    realForm.action = '<?= BASE_URL ?>Controller/AdminController.php?action=login';
