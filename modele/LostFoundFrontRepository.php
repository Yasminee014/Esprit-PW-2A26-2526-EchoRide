...
final class LostFoundFrontRepository
{
    ...
    public function create(array $data): int
    {
        ...
        $stmt = $this->pdo->prepare($sql);
        // Ensure trajet_id references an existing trajet to avoid FK violation
        ...
        if ($providedTrajetId > 0 && $this->trajetExists($providedTrajetId)) {
            ...
            if ($any !== null) {
                ...
                // no trajet rows exist; leave null and hope the DB allows NULL for trajet_id
                $trajetId = null;
            }
        }
    ...
    /**
     * Return any existing trajet id or null if none.
     */
